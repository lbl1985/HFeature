...
fovea.spatial_size = isanetwork{1}.spatial_size; %#ok<USENS>
fovea.temporal_size = isanetwork{1}.temporal_size;
params.avipath = fullfile(baseFolder, 'AVIClips05/');
all_train_files = all_train_files(1 : length(train_indices)); %#ok<NODEF>
...
for i = 1 : nFiles
    ...
    tmpMovieObj = video.croppedVideoVar(tmpMovieVar, fovea.spatial_size);
