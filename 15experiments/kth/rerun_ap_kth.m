...
for ini_idx = 1:params.num_km_init
    ...
    [mean_ap_list(ini_idx), mean_acc_list(ini_idx)] = normalize_chi_svm_wangs_kth(Xtrain, Xtest, norm_type, all_train_files, all_test_files, all_train_labels, all_test_labels, unscramble, params.infopath, 0);    
