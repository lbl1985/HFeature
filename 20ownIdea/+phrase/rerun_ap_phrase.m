...
for ini_idx_word = 1 : params.num_km_init_word
    for ini_idx_phrase = 1 : params.num_km_init_phrase
        ...
        Xtrain = phrase.formhist_phrase(trainPhraseLabelAll, trainPhraseIndices, params, length(all_train_files), MM_train_phrase, ini_idx_word, ini_idx_phrase);
        Xtest  = phrase.formhist_phrase(testPhraseLabelAll, testPhraseIndices, params, length(all_test_files), MM_test_phrase, ini_idx_word, ini_idx_phrase);
