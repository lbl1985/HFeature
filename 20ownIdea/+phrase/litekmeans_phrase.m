...
center_all = cell(params.num_km_init_phrase, 1);
km_obj = cell(params.num_km_init_phrase, 1);
label_all = cell(params.num_km_init_phrase, 1);
for ini_idx = 1 : params.num_km_init_phrase
